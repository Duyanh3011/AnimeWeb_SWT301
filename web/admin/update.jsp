...
<body>
    ...
    <c:set value="${requestScope.video}" var="v"></c:set>
                ...
                <div class="col-lg-12">
                    <div class="login__form">
                        ...
                        <form id="form" action="update" method="post">
                            ...
                            <div class="input__item" style="width: 100%">
                                <input type="text" placeholder="Anime Title" name="title" required="" value="${v.title}">
                                <span class="icon_id"></span>
                            </div>
                            <div class="input__item" style="width: 100%">
                                <input type="text" placeholder="Poster" name="poster" required=""  value="${v.poster}">
                                <span class="icon_image"></span>
                            </div>
                            
                            <div class="input__item" style="width: 100%">
                                <input type="text" placeholder="views" name="views" required="" value="${v.views}">
                            ...
                            <div class="input__item" style="width: 100%">
                                <input type="text" placeholder="Link Anime" name="link" required="" value="${v.link}">
                                <span class="icon_link"></span>
                            </div>
                            <div class="input__item" style="width: 100%">
                                <input type="text" placeholder="Airing Year" name="year" required="" value="${v.year}">
                             ...
                             <select name="seleStudio" >
                                ...
                                <button style="display: block" type="submit" class="site-btn">Update Now</button>
